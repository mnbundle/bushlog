# Django settings for bushlog project.
...
COMPANY = "BushLog"
COMPANY_EMAIL = "info@bushlog.co.za"
if DEBUG:
    COMPANY = ADMINS[0][0]
    COMPANY_EMAIL = ADMINS[0][1]

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',             # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': path.join(PROJECT_PATH, 'bushlog.sqlite'),  # Or path to database file if using sqlite3.
...
SECRET_KEY = 'xGG8*tpar22@bmu&$11Hhbthhgw()eeC4sq_2efj2p$1bSS$$S'
