...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.higher_classification'
        db.add_column(u'wildlife_species', 'higher_classification',
                      self.gf('django.db.models.fields.CharField')(default='mammal', max_length=20),
                      keep_default=True)


    def backwards(self, orm):
        # Deleting field 'Species.higher_classification'
        db.delete_column(u'wildlife_species', 'higher_classification')
