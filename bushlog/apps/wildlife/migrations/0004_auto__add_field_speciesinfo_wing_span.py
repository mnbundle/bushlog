...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpeciesInfo.wing_span'
        db.add_column(u'wildlife_speciesinfo', 'wing_span',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpeciesInfo.wing_span'
        db.delete_column(u'wildlife_speciesinfo', 'wing_span')
    ...
    models = {
        u'wildlife.species': {
            ...
            'higher_classification': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
        ...
        u'wildlife.speciesinfo': {
            ...
            'wing_span': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '1', 'blank': 'True'})
        }
    }
