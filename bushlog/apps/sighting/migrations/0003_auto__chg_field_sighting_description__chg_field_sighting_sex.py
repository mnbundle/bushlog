...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sighting.description'
        db.alter_column('sighting_sighting', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Sighting.sex'
        db.alter_column('sighting_sighting', 'sex', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Sighting.description'
        db.alter_column('sighting_sighting', 'description', self.gf('django.db.models.fields.TextField')(default=' '))

        # Changing field 'Sighting.sex'
        db.alter_column('sighting_sighting', 'sex', self.gf('django.db.models.fields.CharField')(default=' ', max_length=20))
