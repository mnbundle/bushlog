...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sighting_sighting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sightings', to=orm['auth.User'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.Coordinate'])),
            ('reserve', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sightings', to=orm['reserve.Reserve'])),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sightings', to=orm['wildlife.Species'])),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_of_sighting', self.gf('django.db.models.fields.DateTimeField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('estimated_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('sex', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('with_young', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('with_kill', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sighting', ['Sighting'])

        # Adding model 'SightingImage'
        db.create_table('sighting_sightingimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sighting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['sighting.Sighting'])),
        ...
        db.send_create_signal('sighting', ['SightingImage'])


    def backwards(self, orm):
        # Deleting model 'Sighting'
        db.delete_table('sighting_sighting')

        # Deleting model 'SightingImage'
        db.delete_table('sighting_sightingimage')
    ...
    models = {
        ...
        'sighting.sightingimage': {
            ...
            'sighting': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['sighting.Sighting']"})
        },
        'wildlife.species': {
